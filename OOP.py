...
# @martha_samuel_
# 56 sample code to show concept of object oriented programming
...
# <br><br>
# To represe# Author: Dimgba Martha O
# @martha_samuel_
# 56nt the servers that are taking care of the connections, we'll use a Server class. Each connection is represented by an id, that could, for example, be the IP address of the computer connecting to the server.  For our simulation, each connection creates a random amount of load in the server, between 1 and 10.
# <br><br>
